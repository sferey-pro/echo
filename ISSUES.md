...
Ce fichier liste les bugs connus, les limitations actuelles et les axes d'amélioration identifiés par l'équipe (notamment par l'Agent QA) ou par les utilisateurs.
...
- Améliorer la couverture de tests unitaire des composants de base générés par Shadcn UI.
