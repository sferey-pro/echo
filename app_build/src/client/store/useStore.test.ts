...
describe('Zustand Store: useStore', () => {
  ...
  it('should set folders and requests', () => {
    ...
    setRequests([{ id: 'r1', folderId: 'f1', name: 'Req 1', method: 'GET', url: '/', examples: [] }]);
  ...
  it('should update local variant correctly', () => {
    ...
    // Setup initial state
    setRequests([{ 
      id: 'r1', folderId: 'f1', name: 'Req 1', method: 'GET', url: '/', 
      examples: [], 
      variants: [
        { id: 'v1', name: 'V1', isMocked: false, statusCode: 200, latencyMs: 0, payload: '', selectedExample: null, pathParamsOverrides: {} }
      ] 
    }]);
