...
export function EnvironmentViewerModal({ isOpen, onClose, environments, activeEnvironmentName }: EnvironmentViewerModalProps) {
 ...
 <Tray className="w-6 h-6 text-primary" weight="fill" /> Visionneuse d'Environnement
 </DialogTitle>
 </DialogHeader>
 ...
 <p className="text-xs text-muted-foreground mt-2 font-medium">Sélectionnez un environnement dans la liste déroulante pour voir ses variables.</p>
 </div>
 ) : !activeEnv ? (
 ...
 <p className="text-xs mt-2">L'environnement sélectionné ({activeEnvName}) n'existe plus.</p>
 </div>
