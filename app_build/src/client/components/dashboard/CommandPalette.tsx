      ...
      >
        <Command className="w-full h-full flex flex-col bg-transparent" loop>
          ...
          <Command.List className="max-h-[350px] overflow-y-auto p-2 scrollbar-thin scrollbar-thumb-muted-foreground/20">
            ...
            <Command.Group
              heading="Commandes Système"
              className="px-2 py-1.5 mt-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider border-t border-border pt-3"
            >
              <Command.Item
                onSelect={() => {
                  onOpenSettings?.();
