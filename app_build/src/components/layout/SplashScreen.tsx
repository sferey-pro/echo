...
export function SplashScreen({ onComplete }: { onComplete?: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-900 overflow-hidden text-foreground">
      <div className="flex flex-col items-center animate-in slide-in-from-top-12 fade-in duration-700 ease-out fill-mode-both">
        ...
        <div className="w-80 flex flex-col gap-2">
          ...
          <div className="h-6 w-full bg-white border-2 border-black overflow-hidden relative">
            <div 
              className="h-full bg-neo-green border-r-2 border-black transition-all duration-75"
