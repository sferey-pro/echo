    ...
    <div className="h-full bg-neutral-900 flex flex-col relative overflow-hidden">
      ...
      <div className="p-4 border-b border-neutral-800 bg-neutral-900/80 backdrop-blur-md z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" className="h-8 border-neutral-700 bg-neutral-800/50 text-neutral-300 hover:bg-neutral-800 hover:text-white">
            Pass-through
          </Button>
          <Button size="sm" className="h-8 bg-purple-600 hover:bg-purple-700 text-white shadow-lg shadow-purple-900/20">
            Sauvegarder
          </Button>
        </div>
      </div>
